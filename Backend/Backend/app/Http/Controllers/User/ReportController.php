...
{
    public function download(Request $request, int $assessment_id): JsonResponse|\Symfony\Component\HttpFoundation\BinaryFileResponse
    {
        $user       = $request->user();
    ...
    public function status(Request $request, int $assessment_id): JsonResponse
    {
        ...
        return ApiResponse::success([
            ...
            'pdf_path'      => $assessment->pdf_ready
                ? url("storage/{$assessment->pdf_path}")
                : null,
